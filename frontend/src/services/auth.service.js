...
import modalService from './ModalDialog.js';
...
const login = async (usuario, clave, navigateToComponent) => {
    ...
    if (resp.data?.accessToken) {
        ...
        sessionStorage.setItem("usuarioLogueado", resp.data.refreshToken);
        ...
        modalService.Alert("Usuario o clave incorrectas");
    }
};
...
const logout = () => {
    ...
    if (CambioUsuarioLogueado)
        CambioUsuarioLogueado(null);
};
